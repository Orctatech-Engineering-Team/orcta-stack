 ...
 */
export async function getUploadUrl({ key, contentType, expiresIn = 3600 }: UploadOptions): Promise<string> {
 ...
 */
export async function getDownloadUrl({ key, expiresIn = 3600 }: DownloadOptions): Promise<string> {
